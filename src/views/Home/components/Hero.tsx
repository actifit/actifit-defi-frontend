...
const imagePath = '/images/home/actifit-bull/'
const imageSrc = 'actifit-bull-var1'
  ...
  return (
    <>
      ...
      >
        <Flex flex="1" flexDirection="column">
          ...
          <Flex>
            ...
            <Link mr="16px" href="/swap">
              <Button variant="tertiary">{t('Trade Now')}</Button>
            </Link>
          </Flex>
        </Flex>
        <Flex
        ...
        >
          <BunnyWrapper>
            <img src={`${imagePath}${imageSrc}.png`} alt={t('Actifit DeFi Bull')} />
          </BunnyWrapper>
